                    ...
                    <?php echo form_open_multipart(site_url("admin_panel/do_edit_service"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="Service Name" name="name" value="<?=$list[0]->name?>" required>
                                </div>
                            </div>
                            <!-- short desc -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col col-lg-4">
                                    <img id="previewImg1" src="<?=base_url()?>assets/img/services/<?=$list[0]->image?>" width="70px" />
                                    <script>
