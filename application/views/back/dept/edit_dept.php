        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <!-- form -->
                    <?php echo form_open_multipart(site_url("admin_panel/do_edit_dept"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            <!-- dept_name -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Dept. Name<sup style="color: red">*</sup></label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="Department Name" name="dept_name" value="<?=$list[0]->dept_name?>" required>
                                </div>
                            </div>
                            <!-- short desc -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col col-lg-4">
                                    <img id="previewImg1" src="<?=base_url()?>assets/img/dept/<?=$list[0]->image?>" width="70px" />
                                    <script>
