...
<div class="container">
    <div class="row mt-xl" style="margin-top: 10px">
        <?php foreach ($lists as $list) : ?>
            <div class="col-md-4">
                <img src="<?= base_url() ?>assets/img/about_us/<?= $list->image ?>" alt class="img-responsive" />
            </div>
            <div class="col-md-8">
                <h2 class="font-weight-semibold mb-xs"><?= $list->title ?></h2>
                <p class="lead font-weight-normal"><?= $list->short_desc ?></p>
                <p><?= $list->long_desc ?></p>
            </div>
        <?php endforeach; ?>
    </div>
