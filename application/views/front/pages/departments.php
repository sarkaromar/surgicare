...
<div class="container">
    <div class="row pt-xl">
        <div class="col-md-12">
            <h2 class="font-weight-semibold mb-xs">Our Departments</h2>
            ...
            <div class="col-md-4">
                <div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
                    <div class="feature-box-icon">
                        <img src="<?= base_url() ?>assets/img/dept/<?= $list->image ?>" alt class="img-responsive" />
                    </div>
                    <div class="feature-box-info ml-md">
                        <h4 class="font-weight-semibold"><a href="" class="text-decoration-none"><?= $list->dept_name ?></a></h4>
                        <p><?= $list->short_desc ?></p>
                        <a href="<?= base_url() ?>home/departments_details/<?= $list->id ?>" class="btn btn-borders btn-quaternary custom-button text-uppercase mt-sm mb-md font-weight-bold btn-sm">read more</a>
                    </div>  
                </div>
            </div>
        <?php endforeach; ?>
